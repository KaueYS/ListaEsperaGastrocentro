...
namespace ListaEsperaGastrocentro.Controllers
{
    public class PacienteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Telefone,Observacao,DataCadastro,Finalizado")] Paciente paciente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Telefone,Observacao,DataCadastro,Finalizado")] Paciente paciente)
        {
            if (id != paciente.Id)
            {
                return NotFound();
